...
const ModalFormDept: React.FC<ModalFormProps> = ({
  showModal,
  setShowModal,
  onSubmit,
  title,
  fields,
    ...
    const [selectedHeadManager, setSelectedHeadManager] = React.useState<string>();
    ...
    const handleFormSubmit = (e: React.FormEvent) => {
        ...
        if (!selectedHeadManager) return window.alert("veuillez selectionner le chef de departement")

        onSubmit({ ...formData, head: selectedHeadManager as string});
        ...
        <div className="bg-white p-6 rounded-lg shadow-xl max-w-2xl w-full transform scale-100 dark:bg-boxdark">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="flex-none px-3">
                    <label className="block text-gray-700 text-sm font-bold mb-2">Chef du département</label>
                    <select 
                    name="head"
